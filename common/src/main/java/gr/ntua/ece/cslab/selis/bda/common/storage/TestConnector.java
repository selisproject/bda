...
public class TestConnector {
    private final static Logger LOGGER = Logger.getLogger(TestConnector.class.getCanonicalName());
    private static Configuration configuration;
    private static TestConnector systemConnector;
    ...
    public static TestConnector getInstance(){
        if (systemConnector == null){
            systemConnector = new TestConnector();
    ...
    private void initSCNconnections(){
        ...
        for (ScnDbInfo SCN: SCNs){
            elConnectors.put(SCN.getSlug(), ConnectorFactory.getInstance().generateConnector(
                configuration.storageBackend.getEventLogURL()+SCN.getElDbname()+"_test",
            ...
            dtConnectors.put(SCN.getSlug(), ConnectorFactory.getInstance().generateConnector(
                configuration.storageBackend.getDimensionTablesURL()+SCN.getDtDbname()+"_test",
                configuration.storageBackend.getDbUsername(),
                configuration.storageBackend.getDbPassword()
            ));
            ...
            kpiConnectors.put(SCN.getSlug(), ConnectorFactory.getInstance().generateConnector(
                configuration.kpiBackend.getDbUrl()+SCN.getKpiDbname()+"_test",
